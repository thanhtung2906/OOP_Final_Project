...
import pandas as pd
from link_import_dantri import scrape_articles
articles = []
# Load the CSV file containing links and categories
df = pd.read_csv(r"D:\Phenikaa\Python\Final_OOP_Project\OOP_Project\database\dantri_database_link.csv")
...
df_articles.to_csv(r"D:\Phenikaa\Python\Final_OOP_Project\OOP_Project\database\dantri_database_article.csv", index=False, header=True, encoding='utf-8-sig')

print("DanTri article imported successfully")
